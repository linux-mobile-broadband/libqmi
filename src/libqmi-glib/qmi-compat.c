...
qmi_message_dms_set_service_programming_code_input_get_current (
    ...
    GError **error)
{
  return qmi_message_dms_set_service_programming_code_input_get_current_code (self, current, error);
}
...
qmi_message_dms_set_service_programming_code_input_set_current (
    ...
    GError **error)
{
  return qmi_message_dms_set_service_programming_code_input_set_current_code (self, current, error);
}
